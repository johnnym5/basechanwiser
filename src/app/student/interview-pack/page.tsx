    ...
    <AppShell>
      <div className="max-w-5xl mx-auto space-y-8 pb-32">
        ...
        <div style={{ position: "absolute", left: "-9999px", top: "-9999px", width: "800px" }}>
          <div ref={targetRef} style={{ width: "800px", padding: "60px", backgroundColor: "white", color: "black", fontFamily: "serif" }}>
             <h1 style={{ fontSize: "28px", fontWeight: "black", textTransform: "uppercase" }}>UKVI Defense Brief</h1>
             <hr style={{ margin: "20px 0" }} />
             <p><strong>Scholar Name:</strong> {guide.universityName}</p>
...
function StudyGuideTab({ guide, setGuide }: any) {
  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white dark:bg-slate-900/50 p-10 rounded-[40px] border border-gray-100 dark:border-slate-800 shadow-xl">
