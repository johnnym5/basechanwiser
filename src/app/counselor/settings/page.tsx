...
const DEFAULT_PACKS: Omit<QuestionPack, "createdAt" | "updatedAt">[] = DEFAULT_LEARNING_MODULES.map(mod => ({
  id: `core_pack_${mod.id}`,
  title: mod.title,
            ...
            <section className="space-y-10 bg-white dark:bg-[#1E293B] p-8 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-10">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-black text-gray-900 dark:text-white uppercase tracking-tighter">Core Default Packs</h3>
                  </div>
                  <p className="text-xs text-gray-500 font-bold leading-relaxed">Seed the 5 primary UKVI Core Curriculum modules into the Question Pack Library.</p>
                  <button onClick={handleSeedPacks} disabled={seedStatus === "seeding"} className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white font-black rounded-2xl text-xs uppercase transition-all shadow-lg shadow-emerald-500/10">
                    {seedStatus === "seeding" ? "Writing..." : "Seed Default Core Packs"}
                  </button>
