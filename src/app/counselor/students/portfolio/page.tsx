  ...
  if (!student) {
    return (
      <div className="p-20 text-center">
        ...
        <button onClick={() => router.push("/counselor/students")} className="mt-4 text-blue-500 font-black uppercase text-xs hover:underline flex items-center gap-2 mx-auto">
    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
         {[
            ...
            { label: 'Progress', val: `${student.learningProgress || 0}%`, icon: TrendingUp, c: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/10' },
