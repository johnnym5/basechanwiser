      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 space-y-6 text-center transition-all">
        ...
        {mode === "choose" && (
          <div className="space-y-3 pt-2">
            {/* Staff Login — Primary CTA */}
            <button
              onClick={() => { setMode("staff"); setErrorMsg(null); }}
              disabled={isFormDisabled}
              className="w-full py-3.5 px-4 rounded-full bg-[#1a73e8] hover:bg-[#1557b0] text-white font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-500/25 active:scale-[0.98] disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={isFormDisabled}
              className="w-full py-3.5 px-4 rounded-full border-2 border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-100 font-bold text-sm flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-50"
            >
        ...
        {mode === "staff" && (
          <div className="space-y-4 pt-2 text-left">
            <div>
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">Staff Login</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Enter your name and work email to continue.</p>
            </div>

            <div className="space-y-1.5">
              <label htmlFor="staff-name" className="text-xs font-bold text-gray-700 dark:text-gray-200">Full Name</label>
            ...
            <div className="space-y-1.5">
              <label htmlFor="staff-email" className="text-xs font-bold text-gray-700 dark:text-gray-200">Work Email</label>
              <div className="relative">
