          ...
          <div className="space-y-4">
            ...
            <div>
              <h1 className="text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tighter flex items-center gap-3">
                <BookOpen className="w-8 h-8 text-blue-600" /> Resources
              </h1>
              <p className="text-sm text-gray-500 font-bold uppercase tracking-widest mt-1">
                Important documents and guides for your university application.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-16">
            ...
            <section className="space-y-6">
               <div className="flex items-center gap-4">
                  <div className="px-4 py-1.5 bg-blue-600 text-white font-black text-[10px] uppercase tracking-widest rounded-full">Core Lessons</div>
                  <h2 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tighter">Main Modules</h2>
                          ...
                          <div className="flex items-center gap-8 w-full md:w-auto">
                            ...
                            <div className="space-y-2">
                               ...
                               <p className="text-xs text-gray-500 dark:text-gray-400 font-bold leading-relaxed line-clamp-2 max-w-lg">
                                  {mod.summary || "Learn the key rules and check your knowledge."}
                               </p>

                               <div className="flex items-center gap-6 pt-2">
                                  <div className="flex items-center gap-2 text-[9px] font-black text-gray-400 uppercase tracking-widest">
                                     <HelpCircle className="w-4 h-4 text-blue-500" /> 10 Questions
                                  </div>
                                  <div className="flex items-center gap-2 text-[9px] font-black text-gray-400 uppercase tracking-widest">
                                     <Award className="w-4 h-4 text-amber-500" /> {mod.passScore || 80}% Pass Mark
                                  </div>
                               </div>
                            </div>
                          </div>
                          ...
                          <div className="w-full md:w-auto flex flex-col gap-3 pt-6 md:pt-0 border-t md:border-t-0 border-slate-100 dark:border-slate-800 min-w-[200px]">
                            {isLocked ? (
                              <div className="w-full py-4 bg-gray-50 dark:bg-slate-900 rounded-2xl flex items-center justify-center gap-3 text-[10px] font-black text-gray-400 uppercase tracking-widest border border-dashed border-gray-200">
                                 <Lock className="w-4 h-4" /> Locked: Pass previous module
                              </div>
                            ) : (
                              <>
                                {linkedResource ? (
                                  ...
                                  <Link
                                    ...
                                    className="w-full py-4 bg-[#1a73e8] text-white rounded-2xl flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.2em] shadow-xl shadow-blue-500/20 hover:scale-105 active:scale-95 transition-all"
                                  >
                                ...
                                >
                                   {isPassed ? "Retake Quiz" : "Go to Quiz"} <ArrowRight className="w-3 h-3" />
                                </Link>
                              </>
                            )}
                          </div>
            ...
            {supplementalPacks.length > 0 && (
              <section className="space-y-6">
                <div className="flex items-center gap-4">
                    <div className="px-4 py-1.5 bg-indigo-600 text-white font-black text-[10px] uppercase tracking-widest rounded-full">More Practice</div>
                    <h2 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tighter">Extra Quizzes</h2>
                    <div className="h-px bg-gray-100 dark:bg-slate-800 flex-1" />
                </div>
                       ...
                       >
                         <div className="flex items-center gap-8 w-full md:w-auto">
                            ...
                            <div className="space-y-2">
                               ...
                               <p className="text-xs text-gray-500 dark:text-gray-400 font-bold leading-relaxed line-clamp-2 max-w-lg">
                                  {pack.description || "Practice questions for your application."}
                               </p>
                            </div>
                         </div>
                         ...
                         <div className="w-full md:w-auto flex flex-col gap-3 pt-6 md:pt-0 border-t md:border-t-0 border-slate-100 dark:border-slate-800 min-w-[200px]">
                            ...
                            >
                               Go to Quiz <ArrowRight className="w-3 h-3" />
                            </Link>
                         </div>
                       </div>
                     );
